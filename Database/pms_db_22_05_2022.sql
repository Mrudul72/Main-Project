...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2022 at 10:52 AM
...
(3, 'Check Booking Availability', 'Check booking availability after entering the ride details', 2, 35, 1, 1, '2022-05-03', -1),
(4, 'Design Landing Page', 'Landing page should contain contact us form', 1, 35, 2, 1, '2022-05-03', 100),
(5, 'Login And Register Page Design', 'Create a minimal login and register page design', 1, 35, 1, 2, '2022-05-19', 0);
...
(35, 'Vinu Reji John', '9563215684', 'vinu@gmail.com', '1998-06-', '9fa4d6b9792ac4e2997a23926d1980ef', '2022-05-03', 1, 2, 0, 'IMG-20220207-WA0021.jpg'),
...
--
ALTER TABLE `tbl_activity`
  MODIFY `activity_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
