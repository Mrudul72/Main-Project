...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2022 at 06:29 AM
...
(1, 'Design driver registration page', 'Design should be minimal and modern', 1, 35, 2, 1, '2022-05-03', 100),
...
(35, 'Vinu Reji John', '9563215684', 'vinu@gmail.com', '1998-06-', '9fa4d6b9792ac4e2997a23926d1980ef', '2022-05-03', 1, 2, 0, 'defaultuser.png'),
...
--
ALTER TABLE `tbl_activity`
  MODIFY `activity_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
