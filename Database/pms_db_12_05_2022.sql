...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2022 at 07:45 AM
...
(16, 'Vinu Reji John changed status of task \'Design driver registration page\' to Testing ', '', '2022-05-03 22:54:42', 1, 'task'),
(17, 'Vinu Reji John changed status of task \'Design driver registration page\' to Completed ', '', '2022-05-03 22:54:48', 1, 'task'),
(18, 'Vinu Reji John changed status of task \'Design driver registration page\' to Development ', '', '2022-05-03 22:55:02', 1, 'task'),
(19, 'Vinu Reji John changed status of task \'Design driver registration page\' to Backlog ', '', '2022-05-03 22:55:05', 1, 'task'),
(20, 'Mrudul A changed status of task \'Design driver registration page\' to Development ', '', '2022-05-03 23:00:55', 1, 'task'),
...
(22, 'Mrudul A add an attachment to task \'Design driver registration page\'', '', '2022-05-03 23:03:43', 1, 'file'),
(23, 'Abyson Mathew add an attachment to task \'Create Authentication Page\'', '', '2022-05-05 00:10:23', 1, 'file'),
(24, 'Mrudul A changed status of task \'Create Authentication Page\' to Development ', '', '2022-05-05 15:16:00', 1, 'task'),
(25, 'Vinu Reji John changed status of task \'Check Booking Availability\' to Development ', '', '2022-05-06 09:07:42', 1, 'task'),
(26, 'Vinu Reji John changed status of task \'Design Landing Page\' to Development ', '', '2022-05-06 09:07:43', 1, 'task'),
(27, 'Mrudul changed status of task \'Design driver registration page\' to Testing ', '', '2022-05-09 09:27:05', 1, 'task');
...
(1, 'EaseIT - Dashboard.png', '131.31 KB', 37, '2022-05-03', 1, 1),
(2, 'Letter Of Authorization - Background verification.', '353.64 KB', 36, '2022-05-05', 2, 1);
...
(1, 'Design driver registration page', 'Design should be minimal and modern', 1, 35, 3, 1, '2022-05-03', 100),
(2, 'Create Authentication Page', 'Authentication page with otp verification', 2, 35, 2, 1, '2022-05-03', 25),
(3, 'Check Booking Availability', 'Check booking availability after entering the ride details', 2, 35, 2, 1, '2022-05-03', -1),
(4, 'Design Landing Page', 'Landing page should contain contact us form', 1, 35, 2, 1, '2022-05-03', 100);
...
(35, 'Vinu Reji John', '9563215684', 'vinu@gmail.com', '1998-06-', '9fa4d6b9792ac4e2997a23926d1980ef', '2022-05-03', 1, 2, 0, 'IMG20220423055938.jpg'),
...
(38, 'Mrudul', '8563214963', 'mrudul@gmail.com', '2001-07-', 'a93e1669a3924937b28c1bc15061f927', '2022-05-03', 1, 6, 2, 'defaultuser.png'),
(39, 'Meenu Philip', '8563210397', 'meenu@gmail.com', '1999-06-', '550ba481acb35905ed45692c3fab1ebc', '2022-05-08', 1, 7, 0, 'defaultuser.png');
...
--
ALTER TABLE `tbl_activity`
  MODIFY `activity_id` int(14) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_tasks`
  MODIFY `task_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_team_allocation`
  MODIFY `team_allocation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
