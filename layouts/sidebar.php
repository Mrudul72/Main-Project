...
<div class="sidebar-container">
    <nav class="nav-container">
        ...
        <ul class="nav">
            ...
            <a href="./project.php">
                <li class="nav-items <?= ($activePage == 'project') || ($activePage == 'activity') || ($activePage == 'tasks') || ($activePage == 'files') || ($activePage == 'manageProject') || ($activePage=='projectDetails') ? 'active-nav':''; ?>">
                    <span class="ico">
            ...
            <a href="./teams.php">
            <li class="nav-items <?= ($activePage == 'teams') || ($activePage == 'manageteam') || ($activePage == 'teamMemberDetails') || ($activePage == 'userDetails') ? 'active-nav':''; ?> ">
