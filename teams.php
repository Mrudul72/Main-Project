                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form id="createTeamForm" class="modal-form-container" method="post">
                                <input type="hidden" name="member-count" value="0" id="assign-count">
                                <input type="hidden" name="invite-count" value="0" id="assign-count2">
                                    ...
                                    <div id="team-member-select" class="form-group">
                                        ...
                                        <div id="duplicater1" class="input-group mb-3">
                                            <select class="custom-select" name="team-member" id="team-member1" aria-label="Example select with button addon">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM tbl_user WHERE team_id = 0";
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button id="createTeamBtn" type="button" class="btn btn-primary modal-btn-submit">Create</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#createTeamBtn').click(function() {
                    ...
                    let teamMemberArr = [];
                    let inviteMemberArr = [];
                    let teamMemberCount = $('#member-count').val;
                    let inviteMemberCount = $('#invite-count').val;
